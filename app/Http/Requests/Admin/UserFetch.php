...
class UserFetch extends FormRequest
{
    ...
    {
        return [
            'filter.*.key' => 'required|in:id,email,transfer_enable,device_limit,d,expired_at,client_login_at,uuid,token,invite_by_email,invite_user_id,plan_id,banned,remarks,is_admin',
